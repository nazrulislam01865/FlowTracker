...
?>
<div <?php echo e($attributes->class('ft-job-detail-page ft-exact-job-detail ft-detail-products-scope')); ?>>
...
<?php endif; ?><span>Client <strong><?php echo e($job->client?->name ?: '—'); ?></strong></span></span>
                ...
                <span class="ft-order-header-meta-separator" aria-hidden="true">•</span>
                <span class="ft-order-header-meta-item ft-order-header-attention-action" title="<?php echo e($manualAttentionReason ?: 'Request attention from the Order creator and administrators'); ?>">
                    <span>Action:</span>
                    <button type="button" class="ft-order-header-attention-button <?php echo e($manualAttention ? 'is-flagged' : ''); ?>" wire:click="openOrderAttentionReason" <?php if($orderAttentionLocked): echo 'disabled'; endif; ?> aria-label="Request attention" title="<?php echo e($manualAttention ? 'View or update attention request' : 'Request attention'); ?>">
                        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><path d="M6 21V4"></path><path d="M7 5h10l-2 4 2 4H7"></path></svg>
                    </button>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($manualAttention): ?><strong class="ft-order-header-attention-label">Requires attention</strong><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </span>
            </div>
            <div class="ft-exact-job-meta ft-order-status-row" aria-label="Order status">
                ...
                <span class="ft-soft-pill <?php echo e(\App\Support\JobDetailPresenter::taskStatusClass((string) $job->status)); ?>" title="Order status"><?php echo e($job->status ?: 'New'); ?></span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.phase-label','data' => ['phase' => $job->phase,'fallback' => 'Unassigned phase','class' => 'ft-soft-pill','title' => 'Current phase']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['phase' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($job->phase),'fallback' => 'Unassigned phase','class' => 'ft-soft-pill','title' => 'Current phase']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
