...
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames(([
    ...
    'phaseFilter'=>'','healthFilter'=>'','quickFilter'=>'all','showMoreFilters'=>false,
]));
...
<div class="ft-list-page ft-jobs-list-page ft-exact-jobs-list">
    ...
    <div class="ft-list-view-tabs">
        <button class="ft-list-view-chip <?php echo e($quickFilter==='all' ? 'active' : ''); ?>" wire:click="setQuickFilter('all')">All active <b><?php echo e($jobSummary['all'] ?? $jobs->total()); ?></b></button>
    ...
    <section class="ft-job-table-card">
        <div class="ft-job-filter-grid">
            ...
            <button class="ft-outline-btn filter-more <?php echo e($showMoreFilters ? 'active' : ''); ?>" wire:click="toggleMoreFilters" type="button"><svg viewBox="0 0 24 24"><path d="M3 5h18l-7 8v5l-4 2v-7z"/></svg> More filters</button>
            <button class="ft-clear-link" wire:click="clearFilters" type="button">× Clear filters</button>
        </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showMoreFilters): ?>
            <div class="ft-job-more-filter-grid">
        ...
        <div class="ft-active-filter-row"><span><?php echo e($quickFilter==='all' ? 'All active' : \Illuminate\Support\Str::headline($quickFilter)); ?> <button type="button" wire:click="clearFilters">×</button></span></div>

        <div class="ft-job-table-wrap">
            <table class="ft-job-table">
                <thead><tr><th><input type="checkbox"></th><th>Job / Order</th><th>Client / Brief</th><th>Product / Qty</th><th>Phase</th><th>Next Action</th><th>Health</th><th>Owner</th><th>Delivery ↓</th><th>Progress</th><th>Invoice</th><th>•••</th></tr></thead>
                <tbody>
