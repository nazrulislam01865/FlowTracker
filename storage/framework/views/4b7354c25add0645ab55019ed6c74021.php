...
<div id="ft-orders-page" class="ft-orders-prototype">
    <?php if (! $__env->hasRenderedOnce('323b862d-be97-4a23-93a3-2acbf9e4006b')): $__env->markAsRenderedOnce('323b862d-be97-4a23-93a3-2acbf9e4006b'); ?>
        <style>
        ...
        <div class="ft-search-bar">
            ...
            <div class="ft-search-state">
                ...
                <span wire:loading.remove wire:target="search,gotoPage,previousPage,nextPage">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(filled($searchFilter)): ?>
                    ...
                    <?php else: ?>
                        Type to search all <?php echo e(number_format($jobs->total())); ?> orders · results update after 350 ms
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </span>
