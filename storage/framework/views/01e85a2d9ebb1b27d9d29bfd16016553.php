...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.jobs.table','data' => ['jobs' => $jobs,'searchFilter' => $search,'clientFilter' => $client,'phaseFilter' => $phase,'ownerFilter' => $owner,'clientFilterOptions' => $clientFilterOptions,'phaseFilterOptions' => $phaseFilterOptions,'ownerFilterOptions' => $ownerFilterOptions,'clearAction' => 'clearSearch','clearFiltersAction' => 'clearFilters','wire:key' => 'orders-list']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['jobs' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($jobs),'search-filter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($search),'client-filter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($client),'phase-filter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($phase),'owner-filter' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($owner),'client-filter-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientFilterOptions),'phase-filter-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($phaseFilterOptions),'owner-filter-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($ownerFilterOptions),'clear-action' => 'clearSearch','clear-filters-action' => 'clearFilters','wire:key' => 'orders-list']); ?>
