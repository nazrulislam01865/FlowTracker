...
<?php endif; ?>
                ...
                <div
                    class="ft-task-property ft-inline-edit-shell"
                    x-data="{ ...window.FlowTrackInlineEdit({ key: <?php echo \Illuminate\Support\Js::from('task-'.$task->id.'-priority')->toHtml() ?>, label: 'task priority', value: <?php echo \Illuminate\Support\Js::from($task->priority)->toHtml() ?>, display: <?php echo \Illuminate\Support\Js::from($task->priority)->toHtml() ?> }), priorityColor: <?php echo \Illuminate\Support\Js::from($currentPriorityColor)->toHtml() ?> }"
                    :class="{ 'is-inline-saving': status === 'saving', 'is-inline-error': status === 'error' }"
                    x-on:click.outside="if (editing) cancelEdit()"
                >
                    <small>Priority</small>
                    <div x-show="!editing" class="ft-task-property-display"><span class="status-dot ft-master-color-dot" style="<?php echo e(\App\Support\MasterColor::style($currentPriorityColor)); ?>" x-bind:style="priorityColor ? '--ft-master-color:'+priorityColor : ''"></span><b class="ft-property-value" x-text="display"><?php echo e($task->priority); ?></b><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditTask): ?><button type="button" :disabled="status === 'saving'" title="Edit priority" x-on:click.stop="if (beginEdit()) $nextTick(() => $refs.priority?.showPicker ? $refs.priority.showPicker() : $refs.priority?.focus())">✎</button><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEditTask): ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><?php endif; ?>
            ...
            <section class="ft-detail-card ft-attachment-card">
                ...
                <div class="ft-upload-zone compact ft-task-upload-zone">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canUploadDocument && !$showTaskDocumentPicker): ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canLinkDocument): ?><button class="ft-outline-btn ft-task-choose-document" type="button" wire:click="toggleTaskDocumentPicker"><?php echo e($showTaskDocumentPicker && $canUploadDocument ? 'Upload new' : 'Choose from Documents'); ?></button><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$showTaskDocumentPicker && count($taskDocumentUploads ?? [])): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($task->documents->isNotEmpty()): ?>
                    <div class="ft-task-attachment-list" aria-label="Task attachments">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $task->documents->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="ft-order-task-document-row ft-task-detail-document-row" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'task-detail-document-'.e($doc->id).''; ?>wire:key="task-detail-document-<?php echo e($doc->id); ?>">
                                ...
                                <div class="ft-order-task-file-copy">
                                    ...
                                    <small><?php echo e($doc->category ?: 'Task attachment'); ?> · <?php echo e($doc->uploader?->name ?? 'FlowTrack'); ?> · <?php echo e(\App\Support\UserLocalTime::format($doc->created_at, 'M j, Y, g:i A')); ?></small>
                                </div>
        ...
        <aside>
            <section class="ft-detail-card ft-management-card">
                ...
                <div class="ft-attention-row ft-task-flag-row">
                    ...
                    <b class="<?php echo e($currentTaskFlagColor ? 'ft-master-color' : ($currentTaskFlag ? 'danger-text' : '')); ?>" style="<?php echo e(\App\Support\MasterColor::style($currentTaskFlagColor)); ?>;padding:4px 7px;border-radius:7px;border:1px solid transparent"><span class="<?php echo e($currentTaskFlag ? 'ft-red-flag' : ''); ?>">⚑</span> <?php echo e($currentTaskFlag ?: 'No flag'); ?></b>
                </div>
            ...
            <section class="ft-detail-card ft-job-context-card"><h2>Order context</h2><b><?php echo e($job?->title); ?></b><div><span>Client</span><b><?php echo e($job?->client?->name); ?></b></div><div><span>Order health</span><b><?php echo e($job?->health ?: 'On Track'); ?></b></div><div><span>Order flag</span><b class="<?php echo e($currentOrderFlagColor ? 'ft-master-color' : ($currentOrderFlag ? 'danger-text' : '')); ?>" style="<?php echo e(\App\Support\MasterColor::style($currentOrderFlagColor)); ?>;padding:4px 7px;border-radius:7px;border:1px solid transparent"><span class="<?php echo e($currentOrderFlag ? 'ft-red-flag' : ''); ?>">⚑</span> <?php echo e($currentOrderFlag ?: 'No flag'); ?></b></div><div><span>Delivery</span><b><?php echo e($job?->delivery_date?->format('M j, Y') ?? '—'); ?></b></div><div class="ft-context-progress"><span>Order progress</span><b><?php echo e($job?->progress); ?>%</b><div class="ft-line-progress"><span style="width:<?php echo e($job?->progress ?? 0); ?>%"></span></div></div><button class="ft-link-blue ft-open-job" wire:click="closeTask">Open order details ↗</button></section>
