...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.jobs.finance.create-invoice-modal','data' => ['job' => $job,'contacts' => $contacts,'summary' => $summary,'invoiceTypes' => $invoiceTypes,'currencies' => $currencies,'paymentTerms' => $paymentTerms,'invoiceLineItems' => $invoiceLineItems,'invoiceTaxRate' => $invoiceTaxRate,'invoiceCurrency' => $invoiceCurrency,'invoiceType' => $invoiceType,'invoiceRemoteAreaCharge' => $invoiceRemoteAreaCharge,'invoiceRemoteAreaName' => $invoiceRemoteAreaName,'invoiceRemoteAreaPostalCode' => $invoiceRemoteAreaPostalCode,'invoiceSupportingDocument' => $invoiceSupportingDocument]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/StepPromo/resources/views/components/jobs/finance/detail.blade.php ENDPATH**/ ?>