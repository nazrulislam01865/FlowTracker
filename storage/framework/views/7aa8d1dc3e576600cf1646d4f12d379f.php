...
<head>
    ...
    <title>Sign in — <?php echo e($branding['name'] ?? 'FlowTrack'); ?></title>
        ...
        <div>
            <div class="brand ft-login-brand ft-login-brand-dark">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($branding['logo_url'] ?? null): ?>
                    <img src="<?php echo e($branding['logo_url']); ?>" alt="<?php echo e($branding['name'] ?? 'FlowTrack'); ?>">
                <?php else: ?>
                    <div class="brand-mark">FT</div>
                    <span><?php echo e($branding['name'] ?? 'FlowTrack'); ?></span>
