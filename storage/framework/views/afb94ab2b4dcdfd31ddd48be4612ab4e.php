...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.search-select','data' => ['label' => 'Department','property' => 'departmentId','type' => 'departments','context' => 'administration','action' => 'setDepartmentSelection','value' => $departmentId,'placeholder' => 'No department','initialOptions' => $departments,'menuWidth' => 320,'fixedMenu' => true,'wire:key' => 'administration-department-'.e($departmentId ?? 'none').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Department','property' => 'departmentId','type' => 'departments','context' => 'administration','action' => 'setDepartmentSelection','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($departmentId),'placeholder' => 'No department','initial-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($departments),'menu-width' => 320,'fixed-menu' => true,'wire:key' => 'administration-department-'.e($departmentId ?? 'none').'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
