...
<?php endif; ?><div><b><?php echo e($u->name); ?></b><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($u->workspaceMemberships->first()?->job_title): ?><div class="small muted"><?php echo e($u->workspaceMemberships->first()->job_title); ?></div><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?><div class="small muted"><?php echo e($u->email); ?></div></div></div></td>
                ...
                <td><div class="ft-user-role-chips"><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $u->assignedRoles(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignedRole): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?><span class="tag"><?php echo e($assignedRole->name); ?></span><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?><span class="muted">No role</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></div></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.multi-role-select','data' => ['model' => 'roleIds','options' => $roles->filter(fn($r) => $r->is_active || in_array((string) $r->id, array_map('strval', $roleIds), true))->map(fn($r) => ['id' => $r->id, 'name' => $r->name])->values()->all(),'disabled' => $editingUserId && optional($users->firstWhere('id', $editingUserId))->isSuperAdmin(),'placeholder' => 'Select one or more roles']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['model' => 'roleIds','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($roles->filter(fn($r) => $r->is_active || in_array((string) $r->id, array_map('strval', $roleIds), true))->map(fn($r) => ['id' => $r->id, 'name' => $r->name])->values()->all()),'disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($editingUserId && optional($users->firstWhere('id', $editingUserId))->isSuperAdmin()),'placeholder' => 'Select one or more roles']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
