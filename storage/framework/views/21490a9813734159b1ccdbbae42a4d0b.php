...
<section class="section-card integrated-process ft-order-section-card ft-order-workflow-card" id="workflowSection" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'order-detail-workflow-'.e($job->id).'-current-'.e((int) $job->workflow_phase_id).'-selected-'.e((int) ($selectedPhase?->id ?? 0)).''; ?>wire:key="order-detail-workflow-<?php echo e($job->id); ?>-current-<?php echo e((int) $job->workflow_phase_id); ?>-selected-<?php echo e((int) ($selectedPhase?->id ?? 0)); ?>">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/StepPromo/resources/views/components/jobs/order-detail/workflow.blade.php ENDPATH**/ ?>