...
<?php endif; ?>
    ...
    <nav class="ft-client-proto-tabs" aria-label="Client detail sections">
        ...
        <button type="button" wire:click="setClientDetailTab('orders')" class="<?php echo e($tab === 'orders' ? 'active' : ''); ?>">Orders <span><?php echo e($jobs->count()); ?></span></button>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.clients.create','data' => ['mode' => 'edit','users' => $users,'clientCode' => $clientCode,'clientName' => $client->name ?? '','clientCountries' => $clientCountries,'clientCountryFlags' => $clientCountryFlags,'clientStatesByCountry' => $clientStatesByCountry,'clientLanguages' => $clientLanguages,'clientCurrencies' => $clientCurrencies,'paymentTermOptions' => $paymentTermOptions,'accountManagerId' => $accountManagerId,'preferredCurrency' => $preferredCurrency,'clientCountry' => $clientCountry,'billingCountry' => $billingCountry,'billingSameAsOffice' => $billingSameAsOffice,'salesTaxStatus' => $salesTaxStatus,'shippingAddresses' => $editShippingAddresses,'clientLogoUpload' => $clientLogoUpload,'existingClientLogoUrl' => $existingClientLogoUrl,'removeClientLogo' => $removeClientLogo]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <?php elseif($tab === 'overview'): ?>
        ...
        <div class="ft-client-overview-main-grid">
            ...
            <section class="ft-client-proto-card ft-client-contacts-card">
                <div class="ft-client-card-head"><h2>Contacts</h2><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEdit): ?><button class="outlined" type="button" wire:click="editClient(<?php echo e($client->id); ?>)">＋ Add contact</button><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></div>
                <div class="ft-client-contact-row">
                    <div class="ft-client-contact-label">Primary contact <span>Primary</span></div>
                    <div class="ft-client-contact-content"><span class="ft-client-contact-avatar is-blue"><?php echo e($primaryInitials); ?></span><div><b><?php echo e($client->contact_name ?: 'Not set'); ?></b><span><?php echo e($client->contact_job_title ?: '—'); ?></span><span><?php echo e($client->email ?: 'No email recorded'); ?></span><span><?php echo e($client->phone ?: 'No phone recorded'); ?></span></div><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEdit): ?><button type="button" wire:click="editClient(<?php echo e($client->id); ?>)" aria-label="Edit primary contact">✎</button><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></div>
                </div>
                <div class="ft-client-contact-row">
                    <div class="ft-client-contact-label">Billing contact</div>
                    <div class="ft-client-contact-content"><span class="ft-client-contact-avatar is-purple">BC</span><div><b>Not set</b><span>No billing contact recorded</span><span>—</span><span>—</span></div><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEdit): ?><button type="button" wire:click="editClient(<?php echo e($client->id); ?>)" aria-label="Edit billing contact">✎</button><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></div>
                </div>
            </section>
        </div>
    ...
    <?php elseif($tab === 'orders'): ?>
        ...
        <section class="ft-client-proto-card ft-client-orders-card">
            ...
            <div class="ft-client-order-filters">
                ...
                <select wire:model.live="clientOrderStatus"><option value="">All statuses</option><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $orderStatusOptions ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?><option value="<?php echo e($status); ?>"><?php echo e($status); ?></option><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?></select>
                <select wire:model.live="clientOrderOwner"><option value="">All owners</option><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $orderOwnerOptions ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?><option value="<?php echo e($owner->id); ?>"><?php echo e($owner->name); ?></option><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?></select>
                ...
                <table class="ft-client-orders-table">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $orders ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td><span class="ft-client-order-status <?php echo e($statusClass($label)); ?>"><?php echo e($label); ?></span></td>
...
<?php endif; ?><span><?php echo e($ownerName); ?></span></div></td>
    ...
    <?php elseif($tab === 'documents'): ?>
        <section class="ft-client-proto-card ft-client-generic-tab-card">
            <div class="ft-client-card-head"><div><h2>Client documents</h2><p>Documents linked to <?php echo e($client->name); ?>.</p></div><a href="<?php echo e(route('documents.index', ['client'=>$client->id])); ?>" wire:navigate>Open Documents</a></div>
