...
<?php
    ...
    $clientValidationSignature = $errors->any()
        ...
        : '';
?>
<div class="<?php echo e($isEdit ? 'ft-client-inline-edit ft-client-create-prototype ft-reusable-form-theme' : 'ft-create-client-page ft-client-create-prototype ft-reusable-form-theme'); ?>" data-client-validation-signature="<?php echo e($clientValidationSignature); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.select-filter','data' => ['label' => 'Account manager','property' => 'accountManagerId','value' => $accountManagerId ?? '','placeholder' => 'Unassigned','options' => $accountManagerOptions,'selectedLabel' => $selectedManager?->name ?? 'Unassigned','searchPlaceholder' => 'Search account manager…','menuWidth' => 360,'fixedMenu' => true,'hideLabel' => true,'class' => 'ft-form-search-select']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Account manager','property' => 'accountManagerId','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($accountManagerId ?? ''),'placeholder' => 'Unassigned','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($accountManagerOptions),'selected-label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($selectedManager?->name ?? 'Unassigned'),'search-placeholder' => 'Search account manager…','menu-width' => 360,'fixed-menu' => true,'hide-label' => true,'class' => 'ft-form-search-select']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="ft-proto-field ft-shipping-country-field">
                            ...
                            <?php if (isset($component)) { $__componentOriginal4c441a1c27191c086ffa43032f3a6cc2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4c441a1c27191c086ffa43032f3a6cc2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.select-filter','data' => ['label' => 'Country / region','property' => 'billingCountry','value' => $billingCountry,'placeholder' => 'Select country / region','options' => $countryOptions,'searchPlaceholder' => 'Search country / region…','menuWidth' => 360,'fixedMenu' => true,'hideLabel' => true,'class' => 'ft-form-search-select']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.select-filter'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="ft-proto-field ft-shipping-state-field">
                            ...
                            <?php if (isset($component)) { $__componentOriginal4c441a1c27191c086ffa43032f3a6cc2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4c441a1c27191c086ffa43032f3a6cc2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.select-filter','data' => ['label' => 'State','property' => 'billingState','value' => $billingState,'placeholder' => empty($billingStates) ? 'No states configured' : 'Select state','options' => $billingStates,'disabled' => empty($billingStates),'searchPlaceholder' => 'Search state…','menuWidth' => 340,'fixedMenu' => true,'hideLabel' => true,'class' => 'ft-form-search-select']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.select-filter'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
