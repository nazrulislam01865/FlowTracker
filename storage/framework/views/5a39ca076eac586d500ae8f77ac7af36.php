...
<div class="ft-field" data-ft-ui-component="field">
    ...
    <input
        ...
        <?php if(filled($min)): ?> min="<?php echo e($min); ?>" <?php endif; ?>
        <?php if(filled($max)): ?> max="<?php echo e($max); ?>" <?php endif; ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/StepPromo/resources/views/components/ui/date-input.blade.php ENDPATH**/ ?>