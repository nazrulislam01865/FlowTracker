...
<?php endif; ?>
                    ...
                    <span
                        ...
                        x-data="window.FlowTrackInlineEdit({ key: <?php echo \Illuminate\Support\Js::from('my-work-inquiry-task-'.$task['id'].'-due-date')->toHtml() ?>, label: 'inquiry task due date', value: <?php echo \Illuminate\Support\Js::from($task['dueValue'])->toHtml() ?>, display: <?php echo \Illuminate\Support\Js::from($task['dueDisplay'])->toHtml() ?> })"
