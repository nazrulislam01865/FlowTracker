    ...
    >
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($canEdit): ?>
            ...
            <button
                type="button"
                role="menuitem"
                x-on:click="$refs.menu.hidePopover(); $wire.openProductSupplierAssignmentFor(<?php echo e($productId); ?>)"
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/StepPromo/resources/views/components/catalog/action-menu.blade.php ENDPATH**/ ?>