<div class="ft-master-page" <?php if(!$showModal && !$showProductView && !$categoryEditorLevel && !$supplierCreateMode && !$supplierViewId && !$supplierEditId): ?> wire:init="loadMasterRecords" <?php endif; ?>>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($group === 'product'): ?>
        <?php echo $__env->make('livewire.master-data.sections.product', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php elseif($group === 'product_category'): ?>
        <?php echo $__env->make('livewire.master-data.sections.product-category', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php elseif($group === 'supplier' && $supplierCreateMode): ?>
        <?php echo $__env->make('livewire.master-data.sections.supplier-create', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php elseif($group === 'supplier' && $supplierEditId): ?>
        <?php echo $__env->make('livewire.master-data.sections.supplier-edit', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php elseif($group === 'supplier' && $supplierViewId): ?>
        <?php echo $__env->make('livewire.master-data.sections.supplier-detail', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php elseif($group === 'supplier'): ?>
        <?php echo $__env->make('livewire.master-data.sections.supplier-list', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php else: ?>
        <?php echo $__env->make('livewire.master-data.sections.generic-list', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php echo $__env->make('livewire.master-data.sections.generic-editor-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <?php echo $__env->make('livewire.master-data.sections.category-editor', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</div>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/StepPromo/resources/views/livewire/master-data/index.blade.php ENDPATH**/ ?>