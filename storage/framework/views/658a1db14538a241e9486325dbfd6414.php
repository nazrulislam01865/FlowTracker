...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['product', 'canEdit' => false, 'canDelete' => false, 'displayTimezone' => 'UTC']));
...
foreach (array_filter((['product', 'canEdit' => false, 'canDelete' => false, 'displayTimezone' => 'UTC']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
