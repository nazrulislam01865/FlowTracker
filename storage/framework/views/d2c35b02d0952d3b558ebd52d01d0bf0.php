...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <label class="ft-payment-upload">
                <input type="file" wire:model="paymentReceipt" accept="<?php echo e(\App\Support\AttachmentUpload::accept()); ?>">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/StepPromo/resources/views/components/jobs/finance/payment-modal.blade.php ENDPATH**/ ?>