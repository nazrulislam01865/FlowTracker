...
<section class="ft-create-section ft-create-shipping-setup" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'create-order-shipping-setup'; ?>wire:key="create-order-shipping-setup">
    ...
    <div class="ft-create-shipping-modes" role="radiogroup" aria-label="Shipment address mode">
        <label class="ft-create-shipping-mode <?php echo e(! $isMultipleAddressMode ? 'is-selected' : ''); ?>">
            <input
                type="radio"
                name="create-shipment-mode"
                value="multiple_shipments"
                <?php if(! $isMultipleAddressMode): echo 'checked'; endif; ?>
...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isMultipleAddressMode): ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/FlowTracker/resources/views/components/jobs/create/shipping-setup.blade.php ENDPATH**/ ?>