...
<div class="ft-workflow-detail-section ft-exact-workflow">
    <div class="ft-section-title-row"><div><h2>Workflow</h2><p><?php echo e($job->workflow->name); ?> · Version 1</p></div><a class="ft-link-blue" href="<?php echo e(route('workflow.setup')); ?>" wire:navigate>View workflow setup ↗</a></div>
