...
<?php endif; ?>
                    ...
                    <div class="ft-profile-identity-copy">
                        ...
                        <div class="ft-profile-meta-line">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->role?->name): ?><span><?php echo e($user->role->name); ?></span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <aside class="ft-profile-side-column">
            <section class="card ft-profile-side-card ft-profile-company-card">
                ...
                <div class="ft-profile-company-grid ft-profile-company-grid-side">
                    ...
                    <div class="ft-profile-company-item"><span>Role</span><strong><?php echo e($user->role?->name ?: 'Not assigned'); ?></strong></div>
