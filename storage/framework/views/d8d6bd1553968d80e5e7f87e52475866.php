...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php elseif($level === 'sub'): ?>
                <div class="ft-product-search-select-wrap">
                    <?php if (isset($component)) { $__componentOriginal4c441a1c27191c086ffa43032f3a6cc2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4c441a1c27191c086ffa43032f3a6cc2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.select-filter','data' => ['class' => 'ft-product-search-select ft-taxonomy-search-select','label' => 'Product category','property' => 'newSubcategoryProductCategoryId','value' => $selectedProductCategoryId,'placeholder' => 'Select product category','options' => $subcategoryProductCategoryOptions,'clearable' => false,'required' => true,'fixedMenu' => true,'menuWidth' => 430,'searchPlaceholder' => 'Search product category…','footerMessage' => 'Type to search product categories.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.select-filter'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
