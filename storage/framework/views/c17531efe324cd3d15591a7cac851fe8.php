...
#my-work-app .footer,#my-work-app .page-button{font-size:9px}
    ...
    <section class="work-view" aria-busy="false">
        <div class="metrics" aria-label="Personal work summary">
            <button type="button" class="metric amber <?php echo e($quick === 'attention' ? 'active' : ''); ?>" wire:click="setQuick('attention')"><span><small>Needs my action</small><strong x-text="metrics.attention"><?php echo e($metrics['attention'] ?? 0); ?></strong></span><i>⚑</i></button>
            <button type="button" class="metric red <?php echo e($quick === 'overdue' ? 'active' : ''); ?>" wire:click="setQuick('overdue')"><span><small>Overdue</small><strong x-text="metrics.overdue"><?php echo e($metrics['overdue'] ?? 0); ?></strong></span><i>!</i></button>
            <button type="button" class="metric amber <?php echo e($quick === 'today' ? 'active' : ''); ?>" wire:click="setQuick('today')"><span><small>Due today</small><strong x-text="metrics.today"><?php echo e($metrics['today'] ?? 0); ?></strong></span><i>◷</i></button>
            <button type="button" class="metric <?php echo e($quick === 'upcoming' ? 'active' : ''); ?>" wire:click="setQuick('upcoming')"><span><small>Upcoming</small><strong x-text="metrics.upcoming"><?php echo e($metrics['upcoming'] ?? 0); ?></strong></span><i>→</i></button>
            <button type="button" class="metric <?php echo e($quick === 'waiting' ? 'active' : ''); ?>" wire:click="setQuick('waiting')"><span><small>Waiting</small><strong x-text="metrics.waiting"><?php echo e($metrics['waiting'] ?? 0); ?></strong></span><i>⌛</i></button>
        </div>
        ...
        <div class="toolbar">
            ...
            <div class="quick-filters">
                ...
                <button type="button" class="chip <?php echo e($quick === 'mentions' ? 'active' : ''); ?>" wire:click="setQuick('mentions')">Mentions (<span x-text="metrics.mentions"><?php echo e($metrics['mentions'] ?? 0); ?></span>)</button>
            </div>
