...
>
    ...
    <section class="work-view" aria-busy="false">
        <div class="metrics" aria-label="Personal work summary">
            <button type="button" class="metric amber <?php echo e($quick === 'attention' ? 'active' : ''); ?>" wire:click="setMetricFilter('attention')"><span><small>Needs my action</small><strong x-text="metrics.attention ?? '—'"><?php echo e($metrics['attention'] ?? '—'); ?></strong></span><i>⚑</i></button>
            <button type="button" class="metric red <?php echo e($quick === 'overdue' ? 'active' : ''); ?>" wire:click="setMetricFilter('overdue')"><span><small>Overdue</small><strong x-text="metrics.overdue ?? '—'"><?php echo e($metrics['overdue'] ?? '—'); ?></strong></span><i>!</i></button>
            <button type="button" class="metric amber <?php echo e($quick === 'today' ? 'active' : ''); ?>" wire:click="setMetricFilter('today')"><span><small>Due today</small><strong x-text="metrics.today ?? '—'"><?php echo e($metrics['today'] ?? '—'); ?></strong></span><i>◷</i></button>
            <button type="button" class="metric <?php echo e($quick === 'upcoming' ? 'active' : ''); ?>" wire:click="setMetricFilter('upcoming')"><span><small>Upcoming</small><strong x-text="metrics.upcoming ?? '—'"><?php echo e($metrics['upcoming'] ?? '—'); ?></strong></span><i>→</i></button>
            <button type="button" class="metric <?php echo e($quick === 'waiting' ? 'active' : ''); ?>" wire:click="setMetricFilter('waiting')"><span><small>Waiting</small><strong x-text="metrics.waiting ?? '—'"><?php echo e($metrics['waiting'] ?? '—'); ?></strong></span><i>⌛</i></button>
        </div>
        ...
        <div class="toolbar">
            ...
            <div class="toolbar-secondary">
                <div class="quick-filters">
                    <button type="button" class="chip <?php echo e($quick === 'mentions' ? 'active' : ''); ?>" wire:click="setQuick('<?php echo e($quick === 'mentions' ? 'all' : 'mentions'); ?>')">Mentions (<span x-text="metrics.mentions ?? '—'"><?php echo e($metrics['mentions'] ?? '—'); ?></span>)</button>
                </div>
                ...
                <button type="button" class="chip clear-filters" wire:click="clearFilters" <?php if($search === '' && $phaseFilter === '' && $quick === 'all' && !$hideCompleted): echo 'disabled'; endif; ?>>Clear filters</button>
            </div>
        </div>
