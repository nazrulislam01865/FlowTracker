...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <div class="field">
                                ...
                                ?>
                                <div
                                    class="ft-user-editor-department-picker <?php echo e($departmentPickerDisabled ? 'is-disabled' : ''); ?>"
                                    <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'user-editor-department-'.e($departmentId ?? 'none').'-'.e($departmentPickerDisabled ? 'disabled' : 'enabled').''; ?>wire:key="user-editor-department-<?php echo e($departmentId ?? 'none'); ?>-<?php echo e($departmentPickerDisabled ? 'disabled' : 'enabled'); ?>"
                                    x-data="{
                                        open: false,
                                        query: '',
                                        selectedValue: <?php echo \Illuminate\Support\Js::from((string) ($departmentId ?? ''))->toHtml() ?>,
                                        selectedLabel: <?php echo \Illuminate\Support\Js::from($selectedDepartmentLabel)->toHtml() ?>,
                                        options: <?php echo \Illuminate\Support\Js::from(array_values($departmentOptions))->toHtml() ?>,
                                        get filteredOptions() {
                                        ...
                                        openMenu() {
                                            if (<?php echo \Illuminate\Support\Js::from($departmentPickerDisabled)->toHtml() ?>) return;
                                            this.open = true;
                                ...
                                >
                                    <button
                                        ...
                                        <?php if($departmentPickerDisabled): echo 'disabled'; endif; ?>
                                    >
                                        <span x-text="selectedLabel"><?php echo e($selectedDepartmentLabel); ?></span>
