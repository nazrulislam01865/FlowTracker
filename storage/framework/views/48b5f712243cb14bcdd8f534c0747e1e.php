...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['job', 'task', 'config' => [], 'step' => 'main', 'payload' => [], 'modalPreview' => [], 'attachment' => null, 'revisionComments' => [], 'revisionAttachments' => [], 'mentionUsers' => collect(), 'emailFallback' => false, 'emailFallbackMessage' => '', 'emailFallbackAttempts' => 0]));
...
foreach (array_filter((['job', 'task', 'config' => [], 'step' => 'main', 'payload' => [], 'modalPreview' => [], 'attachment' => null, 'revisionComments' => [], 'revisionAttachments' => [], 'mentionUsers' => collect(), 'emailFallback' => false, 'emailFallbackMessage' => '', 'emailFallbackAttempts' => 0]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="ft-order-task-document-modal-backdrop" <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'order-workflow-action-modal-'.e($task->id).'-'.e($step).''; ?>wire:key="order-workflow-action-modal-<?php echo e($task->id); ?>-<?php echo e($step); ?>" <?php if($emailPreviewPending): ?> wire:init="loadOrderWorkflowActionEmailPreview" <?php endif; ?>>
    <section
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.email.handoff-preview','data' => ['loading' => $emailPreviewPending,'preview' => $emailHandoffPreview,'defaultSubject' => 'Purchase Order ready — '.$orderNumber,'emptyRecipientText' => 'Enter an email address in To to see the final email details.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['loading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($emailPreviewPending),'preview' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($emailHandoffPreview),'defaultSubject' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Purchase Order ready — '.$orderNumber),'emptyRecipientText' => 'Enter an email address in To to see the final email details.']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal70137674ee97e22e87c5d4188f3bbd58 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal70137674ee97e22e87c5d4188f3bbd58 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.email.handoff-preview','data' => ['loading' => $emailPreviewPending,'preview' => $emailHandoffPreview,'defaultSubject' => 'Artwork ready — '.$orderNumber,'emptyRecipientText' => 'Enter one or more email addresses in To.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('email.handoff-preview'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['loading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($emailPreviewPending),'preview' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($emailHandoffPreview),'defaultSubject' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Artwork ready — '.$orderNumber),'emptyRecipientText' => 'Enter one or more email addresses in To.']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php elseif($variant === 'production_monitor'): ?>
                <div class="ft-production-monitor-modal-date-row">
                    <label class="ft-prototype-field ft-prototype-field--top">
                        ...
                        <input
                            ...
                            onclick="this.focus({ preventScroll: true }); if (typeof this.showPicker === 'function') { try { this.showPicker(); } catch (e) {} }"
                        >
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['orderWorkflowActionPayload.supplier_delivery_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="validation-error"><?php echo e($message); ?></p><?php unset($message);
            ...
            <?php elseif($variant === 'invoice_send'): ?>
                <div class="ft-invoice-send-workspace">
                        ...
                        <section
                            ...
                            <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'invoice-send-document-'.e($task->id).'-'.e((int) ($workflowInvoice['id'] ?? 0)).''; ?>wire:key="invoice-send-document-<?php echo e($task->id); ?>-<?php echo e((int) ($workflowInvoice['id'] ?? 0)); ?>"
                            wire:ignore
                        >
                        <header class="ft-invoice-send-document__head">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($workflowInvoice)): ?>
                                <div class="ft-invoice-send-document__actions">
                                    <a href="<?php echo e($workflowInvoice['open_url'] ?? '#'); ?>" target="_blank" rel="noopener">Open invoice</a>
                                    <a href="<?php echo e($workflowInvoice['download_url'] ?? '#'); ?>">Download PDF</a>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </header>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($workflowInvoice)): ?>
                            <div class="ft-invoice-send-document__summary">
                                <span><b><?php echo e($workflowInvoice['currency'] ?? ($payload['invoice_currency'] ?? 'USD')); ?> <?php echo e(number_format((float) ($workflowInvoice['total'] ?? 0), 2)); ?></b><small>Amount due</small></span>
                                <span><b><?php echo e($workflowInvoice['issue_date_label'] ?? '—'); ?></b><small>Invoice date</small></span>
                                <span><b><?php echo e($workflowInvoice['due_date_label'] ?? '—'); ?></b><small>Due date</small></span>
                            </div>
                            <div class="ft-invoice-send-pdf-preview">
                                <div class="ft-invoice-send-pdf-preview__bar"><span>PDF</span><b><?php echo e($workflowInvoice['pdf_name'] ?? (($workflowInvoice['invoice_number'] ?? 'Invoice').'.pdf')); ?></b></div>
                                <iframe title="Generated invoice PDF preview" src="<?php echo e($workflowInvoice['open_url'] ?? '#'); ?>"></iframe>
                            </div>
                        <?php else: ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if (isset($component)) { $__componentOriginal70137674ee97e22e87c5d4188f3bbd58 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal70137674ee97e22e87c5d4188f3bbd58 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.email.handoff-preview','data' => ['loading' => $emailPreviewPending,'preview' => $invoiceEmailPreview,'defaultSubject' => 'Invoice '.($payload['invoice_number'] ?? '').' — '.$orderNumber,'emptyRecipientText' => 'Enter the client billing email in To before sending this invoice.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('email.handoff-preview'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['loading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($emailPreviewPending),'preview' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($invoiceEmailPreview),'defaultSubject' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Invoice '.($payload['invoice_number'] ?? '').' — '.$orderNumber),'emptyRecipientText' => 'Enter the client billing email in To before sending this invoice.']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/FlowTracker/resources/views/components/jobs/order-detail/workflow-action-modal.blade.php ENDPATH**/ ?>