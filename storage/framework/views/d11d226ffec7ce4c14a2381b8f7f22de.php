...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.catalog.category-list','data' => ['mainPage' => $categoryMainPage,'productChildren' => $categoryProductChildren,'subcategoryChildren' => $categorySubcategoryChildren,'mainCategories' => $categoryMainCategories,'productCategories' => $categoryProductCategories,'parentOptions' => $categoryParentOptions,'counts' => $categoryCounts,'productCounts' => $categoryProductCounts,'mainProductCounts' => $categoryMainProductCounts,'subcategoryProductCounts' => $categorySubcategoryProductCounts,'productChildTotals' => $categoryProductChildTotals,'subcategoryChildTotals' => $categorySubcategoryChildTotals,'expandedMainIds' => $expandedMainCategoryIds,'expandedProductIds' => $expandedProductCategoryIds,'canCreate' => $canCreateMaster,'canEdit' => $canEditMaster,'canDelete' => $canDeleteMaster,'displayTimezone' => $displayTimezone,'search' => $search,'levelFilter' => $categoryLevelFilter,'parentFilter' => $categoryParentFilter,'statusFilter' => $categoryStatusFilter,'perPage' => $categoryPerPage]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
