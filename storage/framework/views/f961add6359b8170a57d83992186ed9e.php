...
<div class="ft-product-bulk-bar ft-category-bulk-bar" x-data="{ statusOpen: false, moreOpen: false }">
    <div class="ft-product-bulk-summary">
        <strong><?php echo e(number_format($count)); ?> <?php echo e(\Illuminate\Support\Str::plural('category', $count)); ?> selected</strong>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/laravel/StepPromo/resources/views/components/catalog/category-bulk-actions.blade.php ENDPATH**/ ?>