...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['job','compact'=>false,'mentionUsers'=>collect(),'activityTab'=>'all','activityPage'=>1]));
...
foreach (array_filter((['job','compact'=>false,'mentionUsers'=>collect(),'activityTab'=>'all','activityPage'=>1]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php endif; ?>
            <input class="ft-mention-input" wire:model="jobComment" wire:keydown.enter="addJobComment" autocomplete="off" data-mention-users="<?php echo e($mentionUsers->toJson()); ?>" placeholder="Write a comment. Type @ to mention someone...">
...
<?php endif; ?>
                ...
                <div class="ft-activity-entry-content">
                    ...
                    <p><?php if (isset($component)) { $__componentOriginal1d83f45bf838052fadc84bf85b829e43 = $component; } ?>
