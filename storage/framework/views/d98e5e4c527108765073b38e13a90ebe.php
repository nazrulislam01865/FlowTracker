...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.jobs.task-detail','data' => ['task' => $selectedTask,'users' => $users,'taskProgress' => $taskProgress,'taskStatuses' => $taskStatuses,'priorities' => $priorities,'availableDocuments' => $availableDocuments,'activityTab' => $taskActivityTab,'activityPage' => $taskActivityPage,'taskDocumentUploads' => $taskDocumentUploads,'showTaskDocumentPicker' => $showTaskDocumentPicker,'wire:key' => 'task-detail-'.e($selectedTask->id).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.jobs.table','data' => ['jobs' => $jobs,'jobSummary' => $jobSummary,'clients' => $clients,'phases' => $phases,'users' => $users,'priorities' => $priorities,'healthOptions' => $healthOptions,'jobStatuses' => $jobStatuses,'phaseFilter' => $phase,'healthFilter' => $health,'quickFilter' => $quickFilter,'showMoreFilters' => $showMoreFilters,'selectedJobIds' => $selectedJobIds,'allFilteredJobsSelected' => $allFilteredJobsSelected,'wire:key' => 'jobs-table']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
