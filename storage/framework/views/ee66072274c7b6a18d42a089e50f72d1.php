...
?>
<article <?php echo e($attributes->class(['ft-job-card', 'is-expanded' => $expanded, 'health-'.$healthKey])); ?>>
    <span class="ft-job-health-line" aria-hidden="true"></span>

    <div class="ft-job-card-top">
        <div class="ft-job-card-signals">
            <span class="ft-health-pill <?php echo e($job->needs_attention ? 'red' : (in_array($job->health, ['On Track','Completed']) ? 'green' : (in_array($job->health, ['Blocked']) ? 'purple' : 'red'))); ?>">
                <span class="ft-health-dot"></span><?php echo e($job->needs_attention ? 'Needs Attention' : $job->health); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.avatar','data' => ['name' => $phaseTask->assignee?->name ?? 'Unassigned','size' => 30]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($phaseTask->assignee?->name ?? 'Unassigned'),'size' => 30]); ?>
...
<?php endif; ?>
                        ...
                        <span class="ft-phase-task-due <?php echo e($phaseTask->due_date?->isPast() && !$phaseTask->completed_at ? 'overdue' : ''); ?>"><?php echo e($phaseTask->due_date?->format('M j') ?? '—'); ?></span>
                    </a>
...
<?php if (isset($attributes)) { $__attributesOriginald04dd79f9e235eb8e58dee4526a2f3c2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.avatar','data' => ['name' => $nextTask->assignee?->name ?? 'Unassigned','size' => 34]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.avatar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($nextTask->assignee?->name ?? 'Unassigned'),'size' => 34]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?> <?php echo e($nextTask->assignee?->name ?? 'Unassigned'); ?></span>
                ...
                <span class="ft-next-due <?php echo e($nextTask->due_date?->isPast() ? 'overdue' : ''); ?>">
...
<?php if (isset($attributes)) { $__attributesOriginald04dd79f9e235eb8e58dee4526a2f3c2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.avatar','data' => ['name' => $job->coordinator?->name ?? 'Unassigned','size' => 34]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.avatar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($job->coordinator?->name ?? 'Unassigned'),'size' => 34]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="ft-job-team">
        ...
        <div class="ft-team-avatars">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $team->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <?php if (isset($component)) { $__componentOriginald04dd79f9e235eb8e58dee4526a2f3c2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald04dd79f9e235eb8e58dee4526a2f3c2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.avatar','data' => ['name' => $member->name,'size' => 32,'class' => ''.e($loop->even ? 'ft-avatar-green' : '').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.avatar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($member->name),'size' => 32,'class' => ''.e($loop->even ? 'ft-avatar-green' : '').'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="ft-job-footer-grid">
        <div class="ft-job-footer-cell">
            ...
            <div><span>Delivery</span>
                <span class="ft-inline-date ft-job-inline-date <?php echo e($job->delivery_date?->isPast() && !$job->completed_at ? 'overdue' : ''); ?>" x-data="{ editing:false }">
                    <span class="ft-inline-date-display" x-show="!editing"><b><?php echo e($job->delivery_date?->format('M j') ?? 'Set due date'); ?></b></span>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(app(\App\Services\AccessControlService::class)->canEditJob(auth()->user(), $job)): ?>
                        ...
                        <input x-ref="jobDate" x-show="editing" x-on:blur="editing=false" x-on:keydown.escape="editing=false" type="date" value="<?php echo e($job->delivery_date?->format('Y-m-d')); ?>" wire:change="updateJobDueDate(<?php echo e($job->id); ?>, $event.target.value)" aria-label="Job delivery date">
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </span>
            </div>
        </div>
