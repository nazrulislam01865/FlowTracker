...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.clients.create','data' => ['users' => $users,'clientCode' => $clientCode,'clientName' => $clientName,'clientCountries' => $clientCountries,'clientCountryFlags' => $clientCountryFlags,'clientStatesByCountry' => $clientStatesByCountry,'clientLanguages' => $clientLanguages,'clientCurrencies' => $clientCurrencies,'paymentTermOptions' => $paymentTermOptions,'accountManagerId' => $accountManagerId,'preferredCurrency' => $preferredCurrency,'clientCountry' => $clientCountry,'billingCountry' => $billingCountry,'billingSameAsOffice' => $billingSameAsOffice,'salesTaxStatus' => $salesTaxStatus,'shippingAddresses' => $shippingAddresses,'clientLogoUpload' => $clientLogoUpload,'existingClientLogoUrl' => $existingClientLogoUrl,'removeClientLogo' => $removeClientLogo]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['users' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($users),'client-code' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientCode),'client-name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientName),'client-countries' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientCountries),'client-country-flags' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientCountryFlags),'client-states-by-country' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientStatesByCountry),'client-languages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientLanguages),'client-currencies' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientCurrencies),'payment-term-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($paymentTermOptions),'account-manager-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($accountManagerId),'preferred-currency' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($preferredCurrency),'client-country' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientCountry),'billing-country' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($billingCountry),'billing-same-as-office' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($billingSameAsOffice),'sales-tax-status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($salesTaxStatus),'shipping-addresses' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($shippingAddresses),'client-logo-upload' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientLogoUpload),'existing-client-logo-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($existingClientLogoUrl),'remove-client-logo' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($removeClientLogo)]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.clients.detail','data' => ['detail' => $detail,'users' => $users,'editing' => $showEdit,'tab' => $clientDetailTab,'orders' => $clientOrders,'documents' => $clientDocuments,'activities' => $clientActivities,'orderStatusOptions' => $clientOrderStatusOptions,'orderOwnerOptions' => $clientOrderOwnerOptions,'documentCount' => $clientDocumentCount,'orderMetrics' => $clientOrderMetrics,'clientCode' => $clientCode,'clientCountries' => $clientCountries ?? [],'clientCountryFlags' => $clientCountryFlags ?? [],'clientStatesByCountry' => $clientStatesByCountry ?? [],'clientLanguages' => $clientLanguages ?? [],'clientCurrencies' => $clientCurrencies ?? [],'paymentTermOptions' => $paymentTermOptions ?? [],'accountManagerId' => $accountManagerId,'preferredCurrency' => $preferredCurrency,'clientCountry' => $clientCountry,'billingCountry' => $billingCountry,'billingSameAsOffice' => $billingSameAsOffice,'salesTaxStatus' => $salesTaxStatus,'editShippingAddresses' => $shippingAddresses,'clientLogoUpload' => $clientLogoUpload,'existingClientLogoUrl' => $existingClientLogoUrl,'removeClientLogo' => $removeClientLogo]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['detail' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($detail),'users' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($users),'editing' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($showEdit),'tab' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientDetailTab),'orders' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientOrders),'documents' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientDocuments),'activities' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientActivities),'order-status-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientOrderStatusOptions),'order-owner-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientOrderOwnerOptions),'document-count' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientDocumentCount),'order-metrics' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientOrderMetrics),'client-code' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientCode),'client-countries' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientCountries ?? []),'client-country-flags' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientCountryFlags ?? []),'client-states-by-country' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientStatesByCountry ?? []),'client-languages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientLanguages ?? []),'client-currencies' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientCurrencies ?? []),'payment-term-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($paymentTermOptions ?? []),'account-manager-id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($accountManagerId),'preferred-currency' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($preferredCurrency),'client-country' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientCountry),'billing-country' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($billingCountry),'billing-same-as-office' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($billingSameAsOffice),'sales-tax-status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($salesTaxStatus),'edit-shipping-addresses' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($shippingAddresses),'client-logo-upload' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clientLogoUpload),'existing-client-logo-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($existingClientLogoUrl),'remove-client-logo' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($removeClientLogo)]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.list-search','data' => ['property' => 'search','value' => $search,'placeholder' => 'Search archived clients']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.select-filter','data' => ['label' => 'Archived date','property' => 'archivedDate','value' => $archivedDate,'placeholder' => 'All dates','options' => collect([
...
<?php endif; ?>
                    ...
                    ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($chips->isNotEmpty() || $quick !== 'all'): ?>
                        <div class="ft-list-active-row">
                            <div class="ft-list-filter-chips"><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $chips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?><span class="ft-list-filter-chip"><?php echo e($chip['label']); ?><button type="button" wire:click="clearFilter('<?php echo e($chip['key']); ?>')">×</button></span><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?></div>
                            <button type="button" class="ft-list-clear-all" wire:click="clearFilters">Clear all filters</button>
                        </div>
