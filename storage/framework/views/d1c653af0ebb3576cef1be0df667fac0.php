...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.clients.create','data' => ['users' => $users,'clientCode' => $clientCode,'clientCountries' => $clientCountries,'clientCountryFlags' => $clientCountryFlags,'clientStatesByCountry' => $clientStatesByCountry,'clientLanguages' => $clientLanguages,'clientCurrencies' => $clientCurrencies,'paymentTermOptions' => $paymentTermOptions,'accountManagerId' => $accountManagerId,'preferredCurrency' => $preferredCurrency,'clientCountry' => $clientCountry,'billingCountry' => $billingCountry,'billingSameAsOffice' => $billingSameAsOffice,'salesTaxStatus' => $salesTaxStatus,'shippingAddresses' => $shippingAddresses]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
