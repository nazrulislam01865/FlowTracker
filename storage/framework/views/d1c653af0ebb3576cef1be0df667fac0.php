...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.clients.create','data' => ['users' => $users,'clientCode' => $clientCode,'clientName' => $clientName,'clientCountries' => $clientCountries,'clientCountryFlags' => $clientCountryFlags,'clientStatesByCountry' => $clientStatesByCountry,'clientLanguages' => $clientLanguages,'clientCurrencies' => $clientCurrencies,'paymentTermOptions' => $paymentTermOptions,'accountManagerId' => $accountManagerId,'preferredCurrency' => $preferredCurrency,'clientCountry' => $clientCountry,'officeState' => $officeState,'billingState' => $billingState,'billingCountry' => $billingCountry,'billingRecipient' => $billingRecipient,'billingAddressLine1' => $billingAddressLine1,'billingSuite' => $billingSuite,'billingCity' => $billingCity,'billingZip' => $billingZip,'billingSameAsOffice' => $billingSameAsOffice,'salesTaxStatus' => $salesTaxStatus,'shippingAddresses' => $shippingAddresses,'contacts' => $contacts,'clientLogoUpload' => $clientLogoUpload,'existingClientLogoUrl' => $existingClientLogoUrl,'removeClientLogo' => $removeClientLogo]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.clients.detail','data' => ['detail' => $detail,'users' => $users,'editing' => $showEdit,'tab' => $clientDetailTab,'orders' => $clientOrders,'documents' => $clientDocuments,'activities' => $clientActivities,'orderStatusOptions' => $clientOrderStatusOptions,'orderOwnerOptions' => $clientOrderOwnerOptions,'clientOrderSearch' => $clientOrderSearch,'clientOrderStatus' => $clientOrderStatus,'clientOrderOwner' => $clientOrderOwner,'clientOrderRange' => $clientOrderRange,'documentCount' => $clientDocumentCount,'orderMetrics' => $clientOrderMetrics,'clientCode' => $clientCode,'clientCountries' => $clientCountries ?? [],'clientCountryFlags' => $clientCountryFlags ?? [],'clientStatesByCountry' => $clientStatesByCountry ?? [],'clientLanguages' => $clientLanguages ?? [],'clientCurrencies' => $clientCurrencies ?? [],'paymentTermOptions' => $paymentTermOptions ?? [],'accountManagerId' => $accountManagerId,'preferredCurrency' => $preferredCurrency,'clientCountry' => $clientCountry,'officeState' => $officeState,'billingState' => $billingState,'billingCountry' => $billingCountry,'billingRecipient' => $billingRecipient,'billingAddressLine1' => $billingAddressLine1,'billingSuite' => $billingSuite,'billingCity' => $billingCity,'billingZip' => $billingZip,'billingSameAsOffice' => $billingSameAsOffice,'salesTaxStatus' => $salesTaxStatus,'editShippingAddresses' => $shippingAddresses,'contacts' => $contacts,'clientLogoUpload' => $clientLogoUpload,'existingClientLogoUrl' => $existingClientLogoUrl,'removeClientLogo' => $removeClientLogo]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
