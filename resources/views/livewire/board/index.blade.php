<div
    id="my-work-app"
    x-data="{ metrics: @js($taskPackMetrics), groupsExpanded: false }"
        ...
        <section class="list-shell" aria-label="All Tasks grouped by Order">
            ...
            <div>
                @forelse($taskPackGroups as $group)
                    <article class="order-group" wire:key="board-task-order-{{ $group['id'] }}" x-data="{ open: false }" x-effect="open = groupsExpanded">
