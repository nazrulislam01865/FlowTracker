...
<div class="ft-list-page ft-jobs-list-page ft-exact-jobs-list">
    ...
    <div class="ft-list-view-tabs">
        <button class="ft-list-view-chip {{ $quickFilter==='all' ? 'active' : '' }}" wire:click="setQuickFilter('all')">All active <b>{{ $jobSummary['all'] ?? $jobs->total() }}</b></button>
    ...
    <section class="ft-job-table-card">
        <div class="ft-job-filter-grid">
            ...
            <button class="ft-outline-btn filter-more {{ $showMoreFilters ? 'active' : '' }}" wire:click="toggleMoreFilters" type="button"><svg viewBox="0 0 24 24"><path d="M3 5h18l-7 8v5l-4 2v-7z"/></svg> More filters</button>
        ...
        @endif
        <div class="ft-active-filter-row"><span>{{ $quickFilter==='all' ? 'All active' : \Illuminate\Support\Str::headline($quickFilter) }} <button type="button" wire:click="clearFilters">×</button></span></div>
