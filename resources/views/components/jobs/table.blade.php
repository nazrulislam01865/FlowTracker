    ...
    @once
        <style>
            ...
            @media(max-width:680px){
                ...
                .ft-orders-prototype .ft-dashboard-action-match{min-height:36px!important;padding:0 12px!important;font-size:10px!important}.ft-orders-prototype .ft-bulk-import-button,.ft-orders-prototype .ft-list-export-button{height:36px;min-height:36px;padding:0 12px;font-size:10px}
            ...
            @media(max-width:430px){
                ...
                .ft-orders-prototype .ft-dashboard-action-match{min-height:34px!important;padding:0 10px!important;font-size:9.5px!important}.ft-orders-prototype .ft-bulk-import-button,.ft-orders-prototype .ft-list-export-button{height:34px;min-height:34px;padding:0 10px;font-size:9.5px}
            ...
            /* 2026-08-20: View is an action-menu item, not a standalone table column. */
            .ft-orders-prototype .ft-job-head,
            .ft-orders-prototype .ft-job-row{
                grid-template-columns:150px 185px 155px 300px 185px 120px 125px 195px 110px 38px;
                min-width:1680px;
            }
            @media(max-width:1380px){
                .ft-orders-prototype .ft-job-row{
                    min-width:0;
                    grid-template-columns:minmax(140px,1fr) minmax(125px,.8fr) minmax(130px,.9fr) 32px;
                    grid-template-areas:
                        "identity created inquiry actions"
                        "brief brief owner progress"
                        "stage health flag progress";
                }
            }
            @media(max-width:680px){
                .ft-orders-prototype .ft-job-row,
