...
$appUrl = (string) env('APP_URL', 'http://127.0.0.1:8000');
$appHost = (string) (parse_url($appUrl, PHP_URL_HOST) ?: '127.0.0.1');
$appScheme = strtolower((string) (parse_url($appUrl, PHP_URL_SCHEME) ?: 'http'));
$defaultScheme = $appScheme === 'https' ? 'https' : 'http';
...
return [
    ...
    'servers' => [
        'reverb' => [
            ...
            'hostname' => env('REVERB_HOST', $appHost),
            'options' => [
                'tls' => [],
            ],
    ...
    'apps' => [
        ...
        'apps' => [
            [
                ...
                'options' => [
                    'host' => env('REVERB_HOST', $appHost),
                    'port' => env('REVERB_PORT', $defaultPort),
