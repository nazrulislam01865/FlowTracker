...
class FlowNotification extends Model
{
    ...
    public function task(): BelongsTo { return $this->belongsTo(Task::class,'flow_task_id'); }
    public function inquiry(): BelongsTo { return $this->belongsTo(Inquiry::class); }
    public function inquiryTask(): BelongsTo { return $this->belongsTo(InquiryTask::class); }
}
